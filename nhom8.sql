...
-- Thời gian đã tạo: Th10 12, 2022 lúc 11:27 PM
...
(2, 'Iphone 14', 1, 1, 25000000, 'iphone14.jpg', 'iPhone 14 series có sự nâng cấp toàn diện với kiểu dáng mới, nhiều lựa chọn màu sắc trẻ trung, bộ vi xử lý mạnh mẽ, thời lượng pin ấn tượng và camera chuẩn điện ảnh, mang đến trải nghiệm người dùng thông minh nhất từ trước đến nay.', 0, '2022-09-07 17:00:00', NULL, 10),
...
(22, 'Loa Thanh Samsung Q-Series HW-Q600B', 3, 3, 7500000, 'loasamsunghwq600b', 'Bên cạnh tính năng Q-Symphony giúp tận dụng cả loa TV và loa trên soundbar mang đến âm thanh vòm hoàn hảo cho các trải nghiệm giải trí tại gia, năm nay Q-Series được bổ sung công nghệ Spacefit Sound hoàn toàn mới. SpaceFit Sound được áp dụng trên loa thanh Q950A và Q700A, giúp âm thanh được tối ưu hóa qua micro và bộ xử lý của dòng TV Samsung Q70A trở lên. TV đo độ dội âm xảy ra do điều kiện phòng khác nhau và gửi dữ liệu đã xử lý đến loa thanh. Từ đó, loa thanh tối ưu hóa hiệu ứng âm thanh vòm và giọng nói rõ ràng hơn phù hợp với điều kiện phòng. Tính năng này sẽ giúp người nghe cảm nhận được chất lượng âm thanh đồng nhất bất kể không gian căn phòng.', 0, '2018-07-31 19:48:53', NULL, 4),
